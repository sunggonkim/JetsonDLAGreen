...
production TensorRT path is future work.
...
its upstream differential-decision evidence remains incomplete.  We therefore
exclude its numbers.  BOER, ParvaGPU, GSLICE, gpulet, and BLESS are discussed
structurally unless their original runtime executes the same model, input,
release, output, and deadline contract.  This rule prevents fixed quotas or
request-level gating from being relabeled as a published system.
